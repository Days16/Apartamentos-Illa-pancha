            ...
            <>
              ...
              <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                  <div>
                    <label htmlFor="contact-name" className="text-sm font-semibold text-navy block mb-2">{C.labelName}</label>
                    <input
                      id="contact-name"
                  ...
                  <div>
                    <label htmlFor="contact-email" className="text-sm font-semibold text-navy block mb-2">{C.labelEmail}</label>
                    <input
                      id="contact-email"
                      type="email"
                      className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                  <div>
                    <label htmlFor="contact-phone" className="text-sm font-semibold text-navy block mb-2">{C.labelPhone}</label>
                    <input
                      id="contact-phone"
                      className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
                  ...
                  <div>
                    <label htmlFor="contact-apt" className="text-sm font-semibold text-navy block mb-2">{C.labelApt}</label>
                    <select id="contact-apt" className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base cursor-pointer focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all" value={form.apt} onChange={up('apt')}>
                ...
                <div className="mb-5">
                  <label htmlFor="contact-msg" className="text-sm font-semibold text-navy block mb-2">{C.labelMsg}</label>
                  <textarea
                    id="contact-msg"
                    className="w-full px-4 py-3 border border-gray-300 rounded bg-white text-navy text-base focus:outline-none focus:border-teal focus:ring-2 focus:ring-teal/20 transition-all"
