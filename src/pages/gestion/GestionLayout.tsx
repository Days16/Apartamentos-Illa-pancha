...
import { registerPushSubscription, unregisterPushSubscription, isPushSupported } from '../../utils/pushNotifications';
        ...
        <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-1">
          ...
          {isPushSupported() && (
            ...
            >
              ...
              {pushLoading ? 'Procesando...' : pushEnabled ? 'Desactivar notificaciones' : 'Activar notificaciones'}
            </button>
          )}
          <button
            onClick={logout}
