...
function renderCancellationPolicy(lang: string, depositPct: number) {
  const SITE = 'www.apartamentosillapancha.es';
  ...
  const content: Record<string, any> = {
    ES: {
      ...
      general: [
        ...
        ['Estancia mínima:', 'En julio y agosto, la estancia mínima es de 7 noches.'],
        ...
        ['Justificación de cancelaciones:', 'Si cancelas por motivos excepcionales, por favor, envíanos la documentación justificativa junto con tu solicitud de cancelación.'],
      ],
    },
    EN: {
      ...
      general: [
        ...
        ['Minimum stay:', 'In July and August, the minimum stay is 7 nights.'],
        ...
        ['Check-in and check-out times:', 'Check-in is from 4:00 PM and check-out must be before 11:00 AM to guarantee the cleaning service.'],
        ...
        ['Cancellation justification:', 'If you cancel for exceptional reasons, please send us the supporting documentation together with your cancellation request.'],
      ],
    },
    FR: {
      ...
      general: [
        ...
        ['Séjour minimum :', 'En juillet et août, le séjour minimum est de 7 nuits.'],
        ...
        ['Horaires d’arrivée et de départ :', 'L’arrivée se fait à partir de 16h00 et le départ doit avoir lieu avant 11h00 pour garantir le service de ménage.'],
        ...
        ['Justification des annulations :', 'Si vous annulez pour des raisons exceptionnelles, veuillez nous envoyer les pièces justificatives avec votre demande d’annulation.'],
      ],
    },
    DE: {
      ...
      general: [
        ...
        ['Mindestaufenthalt:', 'Im Juli und August beträgt der Mindestaufenthalt 7 Nächte.'],
        ...
        ['Check-in- und Check-out-Zeiten:', 'Check-in ist ab 16:00 Uhr und Check-out muss vor 11:00 Uhr erfolgen, um den Reinigungsservice zu gewährleisten.'],
        ...
        ['Begründung von Stornierungen:', 'Wenn Sie aus außergewöhnlichen Gründen stornieren, senden Sie uns bitte die entsprechenden Belege zusammen mit Ihrem Stornierungsantrag.'],
      ],
    },
    PT: {
      ...
      general: [
        ...
        ['Estadia mínima:', 'Em julho e agosto, a estadia mínima é de 7 noites.'],
        ...
        ['Horários de entrada e saída:', 'A entrada é a partir das 16:00 h e a saída deve ser efetuada antes das 11:00 h para garantir o serviço de limpeza.'],
        ...
        ['Justificação de cancelamentos:', 'Se cancelar por motivos excecionais, por favor, envie-nos a documentação justificativa juntamente com o seu pedido de cancelamento.'],
      ],
    },
  };
